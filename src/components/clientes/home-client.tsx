        ...
        <div className="max-w-[1900px] mx-auto px-4 sm:px-6 py-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 self-start sm:self-auto flex-wrap">
              ...
              <Button variant="outline" size="sm" onClick={() => router.push('/vendas')} className="text-teal-600 dark:text-teal-400 border-teal-300 dark:border-teal-700 hover:bg-teal-50 dark:hover:bg-teal-950/30"><ShoppingCart className="size-4 mr-1.5" />Vendas</Button>
